...
_MOCK_NUTRITION: dict[str, dict] = {
    ...
    # --- Extended mock entries (matching Kroger mock database) ---
    "cod": {
        "usda_food_id": "171958",
        "usda_description": "Fish, cod, Atlantic, raw",
    ...
    "lemon juice": {
        "usda_food_id": "167746",
        "usda_description": "Lemon juice, raw",
    ...
    "garlic powder": {
        "usda_food_id": "171328",
        "usda_description": "Spices, garlic powder",
        "protein_per_100g": 16.6,
        "carbs_per_100g": 72.7,
        "fat_per_100g": 0.7,
        "calories_per_100g": 331.0,
        "data_source": "mock/SR Legacy",
    },
    "paprika": {
        "usda_food_id": "171329",
        "usda_description": "Spices, paprika",
    ...
    "cumin": {
        "usda_food_id": "170926",
        "usda_description": "Spices, cumin seed",
        "protein_per_100g": 17.8,
        "carbs_per_100g": 44.2,
        "fat_per_100g": 22.3,
    ...
    "milk": {
        "usda_food_id": "746782",
        "usda_description": "Milk, whole, 3.25% milkfat",
    ...
    "butter": {
        "usda_food_id": "173410",
        "usda_description": "Butter, without salt",
    ...
    "tomato": {
        "usda_food_id": "170457",
        "usda_description": "Tomatoes, red, ripe, raw",
        "protein_per_100g": 0.9,
        "carbs_per_100g": 3.9,
        "fat_per_100g": 0.2,
    ...
    "peanut butter": {
        "usda_food_id": "172470",
        "usda_description": "Peanut butter, smooth style, without salt",
    ...
    "protein powder": {
        "usda_food_id": "173178",
        "usda_description": "Whey protein isolate",
    ...
    "ground turkey": {
        "usda_food_id": "171506",
        "usda_description": "Turkey, ground, 93% lean, 7% fat, raw",
    ...
    "canned tomatoes": {
        "usda_food_id": "170461",
        "usda_description": "Tomatoes, red, ripe, canned, packed in tomato juice",
    ...
    "pasta": {
        "usda_food_id": "168901",
        "usda_description": "Pasta, cooked, unenriched, without added salt",
    ...
    "bell pepper": {
        "usda_food_id": "170108",
        "usda_description": "Peppers, sweet, green, raw",
        "protein_per_100g": 1.0,
        "carbs_per_100g": 6.0,
        "fat_per_100g": 0.3,
    ...
    "cucumber": {
        "usda_food_id": "168409",
        "usda_description": "Cucumber, with peel, raw",
    ...
    "avocado": {
        "usda_food_id": "171706",
        "usda_description": "Avocados, raw, all commercial varieties",
    ...
    "chickpeas": {
        "usda_food_id": "173757",
        "usda_description": "Chickpeas (garbanzo beans), mature seeds, cooked, boiled",
        "protein_per_100g": 8.9,
        "carbs_per_100g": 27.4,
        "fat_per_100g": 2.6,
    ...
    "tofu": {
        "usda_food_id": "172476",
        "usda_description": "Tofu, firm, prepared with calcium sulfate",
    ...
    "salsa": {
        "usda_food_id": "174271",
        "usda_description": "Sauce, salsa, ready-to-serve",
        "protein_per_100g": 1.1,
        "carbs_per_100g": 5.0,
        "fat_per_100g": 0.3,
    ...
    "russet potato": {
        "usda_food_id": "170026",
        "usda_description": "Potatoes, russet, flesh and skin, raw",
    ...
    "green beans": {
        "usda_food_id": "169961",
        "usda_description": "Beans, snap, green, raw",
    ...
    "cauliflower": {
        "usda_food_id": "169986",
        "usda_description": "Cauliflower, raw",
    ...
    "mushroom": {
        "usda_food_id": "169251",
        "usda_description": "Mushrooms, white, raw",
    ...
    "soy sauce": {
        "usda_food_id": "172237",
        "usda_description": "Soy sauce made from soy (tamari)",
        "protein_per_100g": 8.1,
        "carbs_per_100g": 8.3,
        "fat_per_100g": 0.0,
...
def _fuzzy_match_mock(ingredient: str) -> str | None:
    ...
    for key in _MOCK_NUTRITION:
        if key in query or query in key:
            return key
    # partial word match — also try singular/plural variants (e.g. "egg" matches "eggs")
    query_words = set(query.split())
    query_stemmed = {w.rstrip("s") for w in query_words}  # naive de-plural
    for key in _MOCK_NUTRITION:
        key_words = set(key.split())
        key_stemmed = {w.rstrip("s") for w in key_words}
        if query_words & key_words or query_stemmed & key_stemmed:
            return key
    return None
