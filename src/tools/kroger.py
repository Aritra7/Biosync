...
_MOCK_PRICES: dict[str, dict] = {
    ...
    "cod": {
        "kroger_product_id": "0002114000501",
        "kroger_description": "Atlantic Cod Fillets, Fresh",
        "price_usd": 8.99,
        "unit_size_g": 453.0,   # 1 lb
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "lemon juice": {
        "kroger_product_id": "0004800061108",
        "kroger_description": "ReaLemon 100% Lemon Juice, 15 fl oz",
        "price_usd": 2.49,
        "unit_size_g": 444.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "garlic powder": {
        "kroger_product_id": "0005210006012",
        "kroger_description": "Kroger Garlic Powder, 3.12 oz",
        "price_usd": 2.29,
        "unit_size_g": 88.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "paprika": {
        "kroger_product_id": "0005210006034",
        "kroger_description": "Kroger Paprika, 2.5 oz",
        "price_usd": 2.19,
        "unit_size_g": 71.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "cumin": {
        "kroger_product_id": "0005210006021",
        "kroger_description": "Kroger Ground Cumin, 2.5 oz",
        "price_usd": 2.29,
        "unit_size_g": 71.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "milk": {
        "kroger_product_id": "0001111080822",
        "kroger_description": "Kroger Vitamin D Whole Milk, 1 gal",
        "price_usd": 3.99,
        "unit_size_g": 3785.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "butter": {
        "kroger_product_id": "0001111020902",
        "kroger_description": "Kroger Unsalted Butter, 1 lb",
        "price_usd": 4.49,
        "unit_size_g": 453.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "onion": {
        "kroger_product_id": "0000000004093",
        "kroger_description": "Yellow Onions, Fresh",
        "price_usd": 0.99,
        "unit_size_g": 200.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "garlic": {
        "kroger_product_id": "0000000004608",
        "kroger_description": "Garlic Bulb, Fresh",
        "price_usd": 0.79,
        "unit_size_g": 50.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "tomato": {
        "kroger_product_id": "0000000004087",
        "kroger_description": "Roma Tomatoes, Fresh",
        "price_usd": 0.99,
        "unit_size_g": 150.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "apple": {
        "kroger_product_id": "0000000004129",
        "kroger_description": "Gala Apples, Fresh",
        "price_usd": 0.99,
        "unit_size_g": 200.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "peanut butter": {
        "kroger_product_id": "0005150000112",
        "kroger_description": "Jif Creamy Peanut Butter, 16 oz",
        "price_usd": 3.99,
        "unit_size_g": 453.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "protein powder": {
        "kroger_product_id": "0007910500423",
        "kroger_description": "Optimum Nutrition Whey Protein, 2 lb",
        "price_usd": 29.99,
        "unit_size_g": 907.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "ground turkey": {
        "kroger_product_id": "0002114000302",
        "kroger_description": "Lean Ground Turkey 93/7, 1 lb",
        "price_usd": 5.99,
        "unit_size_g": 453.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "canned tomatoes": {
        "kroger_product_id": "0001111001432",
        "kroger_description": "Kroger Diced Tomatoes, 14.5 oz",
        "price_usd": 0.89,
        "unit_size_g": 411.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "pasta": {
        "kroger_product_id": "0001000010611",
        "kroger_description": "Barilla Penne Pasta, 16 oz",
        "price_usd": 1.79,
        "unit_size_g": 453.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "bell pepper": {
        "kroger_product_id": "0000000004688",
        "kroger_description": "Green Bell Pepper, Fresh",
        "price_usd": 0.99,
        "unit_size_g": 150.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "cucumber": {
        "kroger_product_id": "0000000004062",
        "kroger_description": "English Cucumber, Fresh",
        "price_usd": 1.29,
        "unit_size_g": 300.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "avocado": {
        "kroger_product_id": "0000000094770",
        "kroger_description": "Hass Avocado, Fresh",
        "price_usd": 1.49,
        "unit_size_g": 200.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "chickpeas": {
        "kroger_product_id": "0001111001821",
        "kroger_description": "Kroger Garbanzo Beans (Chickpeas), Canned 15 oz",
        "price_usd": 0.99,
        "unit_size_g": 425.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "tofu": {
        "kroger_product_id": "0002517800039",
        "kroger_description": "Nasoya Firm Tofu, 14 oz",
        "price_usd": 2.49,
        "unit_size_g": 396.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "salsa": {
        "kroger_product_id": "0002840031527",
        "kroger_description": "Pace Chunky Salsa Medium, 24 oz",
        "price_usd": 3.49,
        "unit_size_g": 680.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "russet potato": {
        "kroger_product_id": "0000000094011",
        "kroger_description": "Russet Potatoes, Fresh",
        "price_usd": 0.79,
        "unit_size_g": 250.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "green beans": {
        "kroger_product_id": "0000000004066",
        "kroger_description": "Fresh Green Beans",
        "price_usd": 1.99,
        "unit_size_g": 340.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "cauliflower": {
        "kroger_product_id": "0000000004135",
        "kroger_description": "Cauliflower Head, Fresh",
        "price_usd": 2.99,
        "unit_size_g": 600.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "mushroom": {
        "kroger_product_id": "0000000004682",
        "kroger_description": "White Button Mushrooms, Fresh 8 oz",
        "price_usd": 2.49,
        "unit_size_g": 227.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "soy sauce": {
        "kroger_product_id": "0006038400430",
        "kroger_description": "Kikkoman Soy Sauce, 10 oz",
        "price_usd": 2.99,
        "unit_size_g": 284.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
    ...
    "honey": {
        "kroger_product_id": "0003258000261",
        "kroger_description": "Sue Bee Clover Honey, 12 oz",
        "price_usd": 4.49,
        "unit_size_g": 340.0,
        "store_location": "Kroger #531, Pittsburgh PA 15213",
        "data_source": "mock",
...
def _real_lookup(ingredient_name: str, zip_code: str) -> PriceRecord | None:
    ...
    # If no price data, treat as not found
    if not price_usd:
        return None
